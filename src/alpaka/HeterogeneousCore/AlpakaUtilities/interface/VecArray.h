#ifndef HeterogeneousCore_AlpakaUtilities_interface_VecArray_h
#define HeterogeneousCore_AlpakaUtilities_interface_VecArray_h
...
#endif  // HeterogeneousCore_AlpakaUtilities_interface_VecArray_h
